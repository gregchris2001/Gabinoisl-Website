...
const Search = () => {
    ...
    function searchProducts(productList, searchItem, threshold = 0.05) {
        ...
        const filteredProducts = productList
            ...
            const descriptionScore = calculateSimilarityScore(product.description, searchItem);
    ...
    function calculateSimilarityScore(str1, str2) {
        ...
        const similarityScore = intersection.length / (words1.length + words2.length - intersection.length);
